...
_Note_: Some lamports were removed for transaction fees
...
<ul>
  <li>
    ...
    <code>spl-token mint ...</code>,<code>spl-token authorize ... mint ...</code>
  </li>
  <li>
    Mint account freeze authority:
    <code>spl-token freeze ...</code>,<code>spl-token thaw ...</code>,<code>spl-token authorize ... freeze ...</code>
  </li>
  <li>
    Token account owner authority:
    <code>spl-token transfer ...</code>,<code>spl-token approve ...</code>,<code>
      spl-token revoke ...
    </code>,<code>spl-token burn ...</code>,<code>spl-token wrap ...</code>,<code>
      spl-token unwrap ...
    </code>,<code>spl-token authorize ... owner ...</code>
  </li>
  <li>
    Token account close authority:
    <code>spl-token close ...</code>,<code>spl-token authorize ... close ...</code>
  </li>
</ul>
